from app.models.models import OffreEmploi, Competence, Candidature, Entreprise, Candidature, User, Ville, Fonction, SecteurActivite
from app.shemas.job import OffreIn, ApplyIn, CompetencesIn
...
from app.config import ACCESS_TOKEN_HUGGING_FACE
