...
from app.models.models import User, OffreEmploi
from app.database.database import get_db
from typing import Annotated
from app.shemas.user import UserIn, UserOut, UserUpdate
from app.services.user import check_user_exist, create_and_save_user, get_current_user, hash_password, delete_candidatures, delete_competences, delete_entreprise, delete_resource, update_user, add_jwt_token_to_revoked_tokens
